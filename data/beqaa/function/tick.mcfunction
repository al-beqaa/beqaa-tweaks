...
execute as @e[type=command_block_minecart,tag=beqaa.lodestone_minecart] at @s if block ~ ~ ~ #beqaa:rails unless predicate beqaa:activated run function beqaa:lodestone_minecart/find_pos
